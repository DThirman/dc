...
int actions [NUM_ACTIONS] = {FORWARD, STOP, CALIBRATE_OPP_COLOR, FORWARD, STOP, STOP, LEFT, STOP, BACK, STOP, DEDREKON, FORWARD, FORWARD, FORWARD, STOP, RIGHT, STOP, FORWARD, STOP,
                                ORIGHT, STOP, FORWARD, FORWARD, FORWARD, STOP, RIGHT, STOP, BACK, STOP, DUMP, STOP, FORWARD, STOP, DUMP_UP, STOP, FORWARD, FORWARD, STOP, ORIGHT, STOP, BACK, STOP, 
                                FORWARD, FORWARD, FORWARD, FORWARD, FORWARD, FORWARD, FORWARD, STOP, ORIGHT, STOP, BACK, STOP, DUMP, FORWARD, STOP, DUMP_UP, STOP, RIGHT, STOP, BACK, STOP, FORWARD, FORWARD, FORWARD, DUMP};
